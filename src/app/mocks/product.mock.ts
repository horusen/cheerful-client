...
export const products: Product[] = [
  {
    id: '8392',
    cardName: 'Awo k3 Abefaw VoucherCard',
...
`,
  ...
  {
    id: '464238',
    cardName: 'Kiki Clothing Gift Card',
    description:
  ...
  {
    id: '899935',
    cardName: 'Accra Baby Store Gift Card',
    description:
      'lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
    minPrice: 210,
  ...
  {
    id: '891135',
    cardName: 'Baby Clothing Store Gift Card',
    description:
      'lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
    minPrice: 210,
